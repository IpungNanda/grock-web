    ...
    return (
        ...
        >
            <harga className="w-full md:w-1/2 lg:w-full flex flex-col items-center justify-center border-[2px] bg-slate-800 border-white text-white font-semibold rounded-lg tracking-widest shadow-lg hover:shadow-white transition-all outline-none p-4 md:p-8 ">
                ...
                <h2 className='-ml-16 mr-2 text-slate-300 text-start'>{jenis}</h2>
                ...
                <div className='mt-16'>
                    <div className='grid grid-cols-2 justify-center items-center'>
                        <div className='flex items-center gap-3'>
                            <h1>FreeDomain</h1>
                            <h3 className='ml-24 xl:ml-0'>{domain}</h3>
                        </div>
                    </div>
                ...
                <Link href={
                "https://api.whatsapp.com/send?phone=+62895805399090&text= Hello Grock Web, Saya tertarik dengan paket *PROMO KATALOG*harga 1 juta, bisa minta informasinya lebih lanjut..."
              }   
...
const Sample2 = ({ title, jenis, hargastart,hargafix, text, domain, ssl, hosting, halaman, Bandwidth,  EmailCustom,  WebDesain,  DesainLogo,  DesainResponsive, FiturChatWhatsApp, Support, Garansi, Perpanjangan   }) => {
    return (
        ...
        >
            <harga className="w-full md:w-1/2 lg:w-full flex flex-col items-center justify-center border-[2px] bg-slate-800 border-white text-white font-semibold rounded-lg tracking-widest shadow-lg hover:shadow-white transition-all outline-none p-4 md:p-8 ">
                <h1 className='-ml-16 mr-7 text-white text-2xl font-bold'>{title}</h1>
                ...
                <h3 className='mt-4 text-red-600 text-lg text-center '>{Perpanjangan}</h3>
                <Link href={
                "https://api.whatsapp.com/send?phone=+62895805399090&text= Hello Grock Web, Saya tertarik dengan paket *COMPLETE*harga 2 juta, bisa minta informasinya lebih lanjut..."
              }   
...
const Sample3 = ({ title, jenis, hargastart,hargafix, text, domain, ssl, hosting, halaman, Bandwidth,  EmailCustom,  WebDesain,  DesainLogo,  DesainResponsive, FiturChatWhatsApp, Support, Garansi, Perpanjangan, FiturMarket  }) => {
    return (
        <motion.div
            initial={{ y: 50 }}
            whileInView={{ y: 0 }}
        ...
        >
            <harga className="w-full md:w-1/2 lg:w-full flex flex-col items-center justify-center border-[2px] bg-slate-800 border-white text-white font-semibold rounded-lg tracking-widest shadow-lg hover:shadow-white transition-all outline-none p-4 md:p-8 ">
                <h1 className='-ml-20 mr-24 text-white text-2xl font-bold'>{title}</h1>
                <h2 className='text-slate-300 text-start'>{jenis}</h2>
                <div className='mt-8 flex flex-col items-center'>
                ...
                <div className='mt-16'>
                    ...
                    <div className='grid grid-cols-2 items-center'>
                        <div className='flex items-center'>
                            <h1>Button Marketplace</h1>
                        </div>
                        <h3 className='ml-10'>{FiturMarket}</h3>
                    </div>
                    <div className='grid grid-cols-2 items-center'>
                        <div className='flex items-center'>
                            <h1>Support</h1>
                ...
                <h3 className='mt-4 text-red-600 text-lg text-center '>{Perpanjangan}</h3>
                <Link href={
                "https://api.whatsapp.com/send?phone=+62895805399090&text= Hello Grock Web, Saya tertarik dengan paket *BIG*harga 3 juta, bisa minta informasinya lebih lanjut..."
              }  
...
const Sample4 = ({ title, jenis, hargastart,hargafix, text, domain, ssl, hosting, halaman, Bandwidth,  EmailCustom,  WebDesain,  DesainLogo,  DesainResponsive, FiturChatWhatsApp, Support, Garansi, Perpanjangan, FiturMarket, Cart  }) => {
    return (
        <motion.div
            initial={{ y: 50 }}
            whileInView={{ y: 0 }}
        ...
        >
            <harga className="w-full md:w-1/2 lg:w-full flex flex-col items-center justify-center border-[2px] bg-slate-800 border-white text-white font-semibold rounded-lg tracking-widest shadow-lg hover:shadow-white transition-all outline-none p-4 md:p-8 ">
                <h1 className='-ml-36 text-white text-2xl font-bold'>{title}</h1>
                <h2 className='text-slate-300 text-start'>{jenis}</h2>
                <div className='mt-8 flex flex-col items-center'>
                    <h2 className='text-red-600 mt-2'>{text}</h2>
                    <h3 className='text-bold'>{hargastart}</h3>
                ...
                <div className='mt-16'>
                    ...
                    <div className='grid grid-cols-2 items-center'>
                        <div className='flex items-center'>
                            <h1> Cart & Checkout Order</h1>
                        </div>
                        <h3 className='ml-10'>{Cart}</h3>
                    </div>
                    <div className='grid grid-cols-2 items-center'>
                        <div className='flex items-center'>
                            <h1>Support</h1>
                ...
                <h3 className='mt-4 text-red-600 text-lg text-center '>{Perpanjangan}</h3>
                <Link href={
                "https://api.whatsapp.com/send?phone=+62895805399090&text= Hello Grock Web, Saya tertarik dengan paket *SUPER*harga 4 juta, bisa minta informasinya lebih lanjut..."
              }   
...
export default function HargaTokoOnline() {
    return (
        <main>
                    ...
                    <motion.div className='' variants={variants}>
                        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mt-4 md:mt-24'>
                            ...
                            <div>
                                <Sample2
                                    title="COMPLETE"
                                    jenis="Toko Online Lengkap/Herbal/Fashion Sejenis"
                                    text="Start From :"
                            ...
                            <div>
                                <Sample3
                                    title="BIG"
                                    jenis="Toko Online Bisnis Besar/Fashion"
                                    text="Start From :"
                            ...
                            <div>
                                <Sample4
                                    title="SUPER"
                                    jenis="Toko Online Supermarket/Furniture/Gadget"
                                    text="Start From :"
